                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto items-center">
                    ...
                    <div className="flex bg-gray-100 p-1 rounded-lg w-full sm:w-auto">
                        <button
                            ...
                            className={`flex items-center gap-2 flex-1 sm:flex-none px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'pending'
                        ...
                        >
                            ...
                            <span className={`text-xs font-bold px-1.5 py-0.5 rounded-full ${
                                activeTab === 'pending' ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-200 text-gray-500'
                            }`}>{pendingLoans.length}</span>
                        </button>
                        <button
                            onClick={() => setActiveTab('history')}
                            className={`flex items-center gap-2 flex-1 sm:flex-none px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'history'
                                ? 'bg-white text-indigo-600 shadow-sm'
                                : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                            History
                            <span className={`text-xs font-bold px-1.5 py-0.5 rounded-full ${
                                activeTab === 'history' ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-200 text-gray-500'
                            }`}>{historyLoans.length}</span>
                        </button>
                    </div>
                </div>
            </div>
